...
## 11.10.33 - 2026-08-20
- Raise dependency floors to match current cve-sync policy, and regenerate `template/*/uv.lock` from
  the updated template so a rendered component picks the new minimums up. See the diff for the
  packages that moved.
